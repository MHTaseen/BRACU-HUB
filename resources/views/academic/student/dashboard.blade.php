...
<div class="page-header" style="text-align: center; margin-bottom: 2rem;">
    ...
    <div style="margin-top: 1.5rem;">
        <a href="/api/students/{{ Auth::id() }}/resume/download" class="btn" style="padding: 0.6rem 1.5rem; border-radius: 999px; background: var(--primary-neon); color: #000; font-weight: 700; text-decoration: none; display: inline-block; box-shadow: 0 4px 15px rgba(34, 211, 238, 0.4); transition: transform 0.2s;">📄 Download My Resume</a>
    </div>
</div>
